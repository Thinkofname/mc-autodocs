...
public class Items {
   ...
   public static final ajk LEATHER_HELMET;
   public static final ajk LEATHER_CHESTPLATE;
   public static final ajk LEATHER_LEGGINGS;
   public static final ajk LEATHER_BOOTS;
   public static final ajk CHAINMAIL_HELMET;
   public static final ajk CHAINMAIL_CHESTPLATE;
   public static final ajk CHAINMAIL_LEGGINGS;
   public static final ajk CHAINMAIL_BOOTS;
   public static final ajk IRON_HELMET;
   public static final ajk IRON_CHESTPLATE;
   public static final ajk IRON_LEGGINGS;
   public static final ajk IRON_BOOTS;
   public static final ajk DIAMOND_HELMET;
   public static final ajk DIAMOND_CHESTPLATE;
   public static final ajk DIAMOND_LEGGINGS;
   public static final ajk DIAMOND_BOOTS;
   public static final ajk GOLDEN_HELMET;
   public static final ajk GOLDEN_CHESTPLATE;
   public static final ajk GOLDEN_LEGGINGS;
   public static final ajk GOLDEN_BOOTS;
   ...
   public static final alg FISHING_ROD;
   ...
   public static final amk FILLED_MAP;
   public static final ana SHEARS;
   ...
   public static final amt POTION;
   ...
   public static final akx ENCHANTED_BOOK;
   ...
   public static final ajn ARMOR_STAND;
   ...
   private static Item get(String arg_0) {
      return (Item)Item.e.a(new oa(arg_0));
   }
   ...
   static {
      if(!Bootstrap.hasBootstrapped()) {
         ...
         WHEAT = get("wheat");
         BREAD = get("bread");
         LEATHER_HELMET = (ajk)get("leather_helmet");
         LEATHER_CHESTPLATE = (ajk)get("leather_chestplate");
         LEATHER_LEGGINGS = (ajk)get("leather_leggings");
         LEATHER_BOOTS = (ajk)get("leather_boots");
         CHAINMAIL_HELMET = (ajk)get("chainmail_helmet");
         CHAINMAIL_CHESTPLATE = (ajk)get("chainmail_chestplate");
         CHAINMAIL_LEGGINGS = (ajk)get("chainmail_leggings");
         CHAINMAIL_BOOTS = (ajk)get("chainmail_boots");
         IRON_HELMET = (ajk)get("iron_helmet");
         IRON_CHESTPLATE = (ajk)get("iron_chestplate");
         IRON_LEGGINGS = (ajk)get("iron_leggings");
         IRON_BOOTS = (ajk)get("iron_boots");
         DIAMOND_HELMET = (ajk)get("diamond_helmet");
         DIAMOND_CHESTPLATE = (ajk)get("diamond_chestplate");
         DIAMOND_LEGGINGS = (ajk)get("diamond_leggings");
         DIAMOND_BOOTS = (ajk)get("diamond_boots");
         GOLDEN_HELMET = (ajk)get("golden_helmet");
         GOLDEN_CHESTPLATE = (ajk)get("golden_chestplate");
         GOLDEN_LEGGINGS = (ajk)get("golden_leggings");
         GOLDEN_BOOTS = (ajk)get("golden_boots");
         FLINT = get("flint");
         ...
         EGG = get("egg");
         COMPASS = get("compass");
         FISHING_ROD = (alg)get("fishing_rod");
         CLOCK = get("clock");
         ...
         COOKIE = get("cookie");
         FILLED_MAP = (amk)get("filled_map");
         SHEARS = (ana)get("shears");
         MELON = get("melon");
