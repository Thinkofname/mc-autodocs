...
public class Items {
   ...
   public static final ajg LEATHER_HELMET;
   public static final ajg LEATHER_CHESTPLATE;
   public static final ajg LEATHER_LEGGINGS;
   public static final ajg LEATHER_BOOTS;
   public static final ajg CHAINMAIL_HELMET;
   public static final ajg CHAINMAIL_CHESTPLATE;
   public static final ajg CHAINMAIL_LEGGINGS;
   public static final ajg CHAINMAIL_BOOTS;
   public static final ajg IRON_HELMET;
   public static final ajg IRON_CHESTPLATE;
   public static final ajg IRON_LEGGINGS;
   public static final ajg IRON_BOOTS;
   public static final ajg DIAMOND_HELMET;
   public static final ajg DIAMOND_CHESTPLATE;
   public static final ajg DIAMOND_LEGGINGS;
   public static final ajg DIAMOND_BOOTS;
   public static final ajg GOLDEN_HELMET;
   public static final ajg GOLDEN_CHESTPLATE;
   public static final ajg GOLDEN_LEGGINGS;
   public static final ajg GOLDEN_BOOTS;
   ...
   public static final alc FISHING_ROD;
   ...
   public static final amg FILLED_MAP;
   public static final amw SHEARS;
   ...
   public static final amp POTION;
   ...
   public static final akt ENCHANTED_BOOK;
   ...
   public static final ajj ARMOR_STAND;
   ...
   private static Item get(String arg_0) {
      return (Item)Item.e.a(new nz(arg_0));
   }
   ...
   static {
      if(!Bootstrap.hasBootstrapped()) {
         ...
         WHEAT = get("wheat");
         BREAD = get("bread");
         LEATHER_HELMET = (ajg)get("leather_helmet");
         LEATHER_CHESTPLATE = (ajg)get("leather_chestplate");
         LEATHER_LEGGINGS = (ajg)get("leather_leggings");
         LEATHER_BOOTS = (ajg)get("leather_boots");
         CHAINMAIL_HELMET = (ajg)get("chainmail_helmet");
         CHAINMAIL_CHESTPLATE = (ajg)get("chainmail_chestplate");
         CHAINMAIL_LEGGINGS = (ajg)get("chainmail_leggings");
         CHAINMAIL_BOOTS = (ajg)get("chainmail_boots");
         IRON_HELMET = (ajg)get("iron_helmet");
         IRON_CHESTPLATE = (ajg)get("iron_chestplate");
         IRON_LEGGINGS = (ajg)get("iron_leggings");
         IRON_BOOTS = (ajg)get("iron_boots");
         DIAMOND_HELMET = (ajg)get("diamond_helmet");
         DIAMOND_CHESTPLATE = (ajg)get("diamond_chestplate");
         DIAMOND_LEGGINGS = (ajg)get("diamond_leggings");
         DIAMOND_BOOTS = (ajg)get("diamond_boots");
         GOLDEN_HELMET = (ajg)get("golden_helmet");
         GOLDEN_CHESTPLATE = (ajg)get("golden_chestplate");
         GOLDEN_LEGGINGS = (ajg)get("golden_leggings");
         GOLDEN_BOOTS = (ajg)get("golden_boots");
         FLINT = get("flint");
         ...
         EGG = get("egg");
         COMPASS = get("compass");
         FISHING_ROD = (alc)get("fishing_rod");
         CLOCK = get("clock");
         ...
         COOKIE = get("cookie");
         FILLED_MAP = (amg)get("filled_map");
         SHEARS = (amw)get("shears");
         MELON = get("melon");
