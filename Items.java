...
public class Items {
   ...
   public static final ajh LEATHER_HELMET;
   public static final ajh LEATHER_CHESTPLATE;
   public static final ajh LEATHER_LEGGINGS;
   public static final ajh LEATHER_BOOTS;
   public static final ajh CHAINMAIL_HELMET;
   public static final ajh CHAINMAIL_CHESTPLATE;
   public static final ajh CHAINMAIL_LEGGINGS;
   public static final ajh CHAINMAIL_BOOTS;
   public static final ajh IRON_HELMET;
   public static final ajh IRON_CHESTPLATE;
   public static final ajh IRON_LEGGINGS;
   public static final ajh IRON_BOOTS;
   public static final ajh DIAMOND_HELMET;
   public static final ajh DIAMOND_CHESTPLATE;
   public static final ajh DIAMOND_LEGGINGS;
   public static final ajh DIAMOND_BOOTS;
   public static final ajh GOLDEN_HELMET;
   public static final ajh GOLDEN_CHESTPLATE;
   public static final ajh GOLDEN_LEGGINGS;
   public static final ajh GOLDEN_BOOTS;
   ...
   public static final ald FISHING_ROD;
   ...
   public static final amh FILLED_MAP;
   public static final amx SHEARS;
   ...
   public static final amq POTION;
   ...
   public static final aku ENCHANTED_BOOK;
   ...
   public static final ajk ARMOR_STAND;
   ...
   static {
      if(!Bootstrap.hasBootstrapped()) {
         ...
         WHEAT = get("wheat");
         BREAD = get("bread");
         LEATHER_HELMET = (ajh)get("leather_helmet");
         LEATHER_CHESTPLATE = (ajh)get("leather_chestplate");
         LEATHER_LEGGINGS = (ajh)get("leather_leggings");
         LEATHER_BOOTS = (ajh)get("leather_boots");
         CHAINMAIL_HELMET = (ajh)get("chainmail_helmet");
         CHAINMAIL_CHESTPLATE = (ajh)get("chainmail_chestplate");
         CHAINMAIL_LEGGINGS = (ajh)get("chainmail_leggings");
         CHAINMAIL_BOOTS = (ajh)get("chainmail_boots");
         IRON_HELMET = (ajh)get("iron_helmet");
         IRON_CHESTPLATE = (ajh)get("iron_chestplate");
         IRON_LEGGINGS = (ajh)get("iron_leggings");
         IRON_BOOTS = (ajh)get("iron_boots");
         DIAMOND_HELMET = (ajh)get("diamond_helmet");
         DIAMOND_CHESTPLATE = (ajh)get("diamond_chestplate");
         DIAMOND_LEGGINGS = (ajh)get("diamond_leggings");
         DIAMOND_BOOTS = (ajh)get("diamond_boots");
         GOLDEN_HELMET = (ajh)get("golden_helmet");
         GOLDEN_CHESTPLATE = (ajh)get("golden_chestplate");
         GOLDEN_LEGGINGS = (ajh)get("golden_leggings");
         GOLDEN_BOOTS = (ajh)get("golden_boots");
         FLINT = get("flint");
         ...
         EGG = get("egg");
         COMPASS = get("compass");
         FISHING_ROD = (ald)get("fishing_rod");
         CLOCK = get("clock");
         ...
         COOKIE = get("cookie");
         FILLED_MAP = (amh)get("filled_map");
         SHEARS = (amx)get("shears");
         MELON = get("melon");
