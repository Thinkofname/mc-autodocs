...
public class Blocks {
   ...
   public static final awk GRASS;
   public static final Block DIRT;
   public static final Block COBBLESTONE;
   public static final Block PLANKS;
   public static final Block SAPLING;
   public static final Block BEDROCK;
   public static final avk FLOWING_WATER;
   public static final bau WATER;
   public static final avk FLOWING_LAVA;
   public static final bau LAVA;
   public static final azy SAND;
   ...
   public static final axd LEAVES;
   public static final axd LEAVES2;
   ...
   public static final bdn STICKY_PISTON;
   public static final Block WEB;
   public static final bbe TALLGRASS;
   public static final aut DEADBUSH;
   public static final bdn PISTON;
   public static final bdp PISTON_HEAD;
   public static final Block WOOL;
   public static final bdu PISTON_EXTENSION;
   public static final avv YELLOW_FLOWER;
   public static final avv RED_FLOWER;
   public static final atz BROWN_MUSHROOM;
   public static final atz RED_MUSHROOM;
   public static final Block GOLD_BLOCK;
   public static final Block IRON_BLOCK;
   public static final awn DOUBLE_STONE_SLAB;
   public static final awn STONE_SLAB;
   ...
   public static final avu FIRE;
   public static final Block MOB_SPAWNER;
   public static final Block OAK_STAIRS;
   public static final aug CHEST;
   public static final azq REDSTONE_WIRE;
   ...
   public static final auc CACTUS;
   public static final Block CLAY;
   public static final azv REEDS;
   ...
   public static final ayv PORTAL;
   public static final Block LIT_PUMPKIN;
   public static final Block CAKE;
   public static final azw UNPOWERED_REPEATER;
   public static final azw POWERED_REPEATER;
   ...
   public static final axz MYCELIUM;
   ...
   public static final auf CAULDRON;
   ...
   public static final awn DOUBLE_WOODEN_SLAB;
   public static final awn WOODEN_SLAB;
   ...
   public static final bbq TRIPWIRE_HOOK;
   ...
   public static final atj BEACON;
   ...
   public static final aum UNPOWERED_COMPARATOR;
   public static final aum POWERED_COMPARATOR;
   public static final aus DAYLIGHT_DETECTOR;
   public static final aus DAYLIGHT_DETECTOR_INVERTED;
   public static final Block REDSTONE_BLOCK;
   public static final Block QUARTZ_ORE;
   public static final awu HOPPER;
   ...
   public static final avf DOUBLE_PLANT;
   public static final bao STAINED_GLASS;
   public static final bap STAINED_GLASS_PANE;
   ...
   public static final awn DOUBLE_STONE_SLAB2;
   public static final awn STONE_SLAB2;


   private static Block get(String arg_0) {
      return (Block)Block.c.a(new oa(arg_0));
   }
   ...
   static {
      if(!Bootstrap.hasBootstrapped()) {
         ...
         SAPLING = get("sapling");
         BEDROCK = get("bedrock");
         FLOWING_WATER = (avk)get("flowing_water");
         WATER = (bau)get("water");
         FLOWING_LAVA = (avk)get("flowing_lava");
         LAVA = (bau)get("lava");
         SAND = (azy)get("sand");
         GRAVEL = get("gravel");
         ...
         LOG = get("log");
         LOG2 = get("log2");
         LEAVES = (axd)get("leaves");
         LEAVES2 = (axd)get("leaves2");
         SPONGE = get("sponge");
         GLASS = get("glass");
         ...
         STICKY_PISTON = (bdn)get("sticky_piston");
         WEB = get("web");
         TALLGRASS = (bbe)get("tallgrass");
         DEADBUSH = (aut)get("deadbush");
         PISTON = (bdn)get("piston");
         PISTON_HEAD = (bdp)get("piston_head");
         WOOL = get("wool");
         PISTON_EXTENSION = (bdu)get("piston_extension");
         YELLOW_FLOWER = (avv)get("yellow_flower");
         RED_FLOWER = (avv)get("red_flower");
         BROWN_MUSHROOM = (atz)get("brown_mushroom");
         RED_MUSHROOM = (atz)get("red_mushroom");
         GOLD_BLOCK = get("gold_block");
         IRON_BLOCK = get("iron_block");
         DOUBLE_STONE_SLAB = (awn)get("double_stone_slab");
         STONE_SLAB = (awn)get("stone_slab");
         ...
         CHEST = (aug)get("chest");
         REDSTONE_WIRE = (azq)get("redstone_wire");
         ...
         PORTAL = (ayv)get("portal");
         LIT_PUMPKIN = get("lit_pumpkin");
         CAKE = get("cake");
         UNPOWERED_REPEATER = (azw)get("unpowered_repeater");
         POWERED_REPEATER = (azw)get("powered_repeater");
         ...
         DOUBLE_WOODEN_SLAB = (awn)get("double_wooden_slab");
         WOODEN_SLAB = (awn)get("wooden_slab");
         COCOA = get("cocoa");
         SANDSTONE_STAIRS = get("sandstone_stairs");
         EMERALD_ORE = get("emerald_ore");
         ENDER_CHEST = get("ender_chest");
         TRIPWIRE_HOOK = (bbq)get("tripwire_hook");
         ...
         UNPOWERED_COMPARATOR = (aum)get("unpowered_comparator");
         POWERED_COMPARATOR = (aum)get("powered_comparator");
         DAYLIGHT_DETECTOR = (aus)get("daylight_detector");
         DAYLIGHT_DETECTOR_INVERTED = (aus)get("daylight_detector_inverted");
         REDSTONE_BLOCK = get("redstone_block");
         QUARTZ_ORE = get("quartz_ore");
         HOPPER = (awu)get("hopper");
         ...
         SLIME = get("slime");
         DOUBLE_PLANT = (avf)get("double_plant");
         STAINED_GLASS = (bao)get("stained_glass");
         STAINED_GLASS_PANE = (bap)get("stained_glass_pane");
         ...
         DOUBLE_STONE_SLAB2 = (awn)get("double_stone_slab2");
         STONE_SLAB2 = (awn)get("stone_slab2");
      }
   }
}
