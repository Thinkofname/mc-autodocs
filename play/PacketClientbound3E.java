...
public class PacketClientbound3E implements hf {
   ...
   public PacketClientbound3E(blp var1, int var2) {
      this.e = blw.a.e;
      this.f = -1;
      this.g = Lists.newArrayList();
      this.a = var1.b();
   ...
   public PacketClientbound3E(blp var1, Collection var2, int var3) {
      this.e = blw.a.e;
      this.f = -1;
      this.g = Lists.newArrayList();
      if(var3 != 3 && var3 != 4) {
