...
public class PacketClientbound42 extends gv {
   ...
   public PacketClientbound42(th var1, is var2) {
      this.a = var2;
      uo var3 = var1.c();
      switch(ir.a[var2.ordinal()]) {
      case 1:
         this.d = var1.f();
   ...
   public void read(PacketBuffer var1) {
      this.a = (is)is.d.get(Integer.valueOf(var1.readUnsignedByte()));
      if(this.a == is.b) {
