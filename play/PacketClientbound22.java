...
public class PacketClientbound22 extends ga {
   ...
   public PacketClientbound22(int var1, short[] var2, aqm var3) {
      this.b = new agv(var3.a, var3.b);
      this.d = var1;
      int var4 = 4 * var1;
      ...
      try {
         ...
         for(int var7 = 0; var7 < var1; ++var7) {
            ...
            var6.writeShort((short)((ajj.b(var3.a(var8, var10, var9)) & 4095) << 4 | var3.b(var8, var10, var9) & 15));
         }
   ...
   public void read(PacketBuffer var1) {
      this.b = new agv(var1.readInt(), var1.readInt());
