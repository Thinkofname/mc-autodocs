...
public class PacketClientbound26 extends gj {
   ...
   public PacketClientbound26(List var1) {
      ...
      this.h = !var1.isEmpty() && !((arg)var1.get(0)).p().s.p();
      int var3 = 0;

      for(int var4 = 0; var4 < var2; ++var4) {
         arg var5 = (arg)var1.get(var4);
         hq var6 = hp.a(var5, true, '\uffff');
