...
public class PacketClientbound34 implements hz {
   ...
   public PacketClientbound34(int var1, byte var2, Collection var3, byte[] var4, int var5, int var6, int var7, int var8) {
      this.a = var1;
      this.b = var2;
      this.c = (bog[])var3.toArray(new bog[var3.size()]);
      this.d = var5;
      this.e = var6;
      this.f = var7;
      this.g = var8;
   ...
   public void read(PacketBuffer var1) {
      ...
      this.c = new bog[var1.readVarInt()];

      for(int var2 = 0; var2 < this.c.length; ++var2) {
         short var3 = (short)var1.readByte();
         this.c[var2] = new bog((byte)(var3 >> 4 & 15), var1.readByte(), var1.readByte(), (byte)(var3 & 15));
      }
