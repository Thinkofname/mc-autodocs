...
public class PacketMaps implements Packet {
   ...
   public PacketMaps(int arg_0, byte arg_1, Collection arg_2, byte[] arg_3, int arg_4, int arg_5, int arg_6, int arg_7) {
      this.a = arg_0;
      this.b = arg_1;
      this.c = (bqd[])arg_2.toArray(new bqd[arg_2.size()]);
      this.d = arg_4;
      this.e = arg_5;
      this.f = arg_6;
      this.g = arg_7;
   ...
   public void read(PacketByteBuf in) {
      ...
      this.b = in.readByte();
      this.c = new bqd[in.readVarInt()];

      for(int var2 = 0; var2 < this.c.length; ++var2) {
         short var3 = (short)in.readByte();
         this.c[var2] = new bqd((byte)(var3 >> 4 & 15), in.readByte(), in.readByte(), (byte)(var3 & 15));
      }
   ...
   public void a(bqe arg_0) {
      arg_0.e = this.b;
      arg_0.h.clear();

      int var2;
      for(var2 = 0; var2 < this.c.length; ++var2) {
         bqd var3 = this.c[var2];
